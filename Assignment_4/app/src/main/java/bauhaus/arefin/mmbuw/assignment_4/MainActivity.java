package bauhaus.arefin.mmbuw.assignment_4;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataPrint = (Button) findViewById(R.id.dataPrint);
        ...
        dataPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CharSequence text = "Raw Data : " + message;
    ...
    private void handleIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) {
            ...
            if (MIME_TEXT_PLAIN.equals(type)) {
                ...
                nfcId.setText("ID : " + tag.getId().toString());
                dataType.setText("Type : " + type);
